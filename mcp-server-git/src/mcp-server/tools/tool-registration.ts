      ...
      () => {
        ...
        server.registerTool(
          tool.name,
          {
            ...
            // FIX: Don't pass outputSchema to registerTool
            // The MCP SDK validates CallToolResult.structuredContent against this schema,
            // but our tools return both 'content' and 'structuredContent' fields.
            // By omitting outputSchema, we disable schema validation and let the
            // tool handler's return type guide the response structure.
